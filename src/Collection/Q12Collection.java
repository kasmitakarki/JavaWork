...
public class Q12Collection {
	public static void main(String[] args) {
		...
		System.out.println("Enter roman number here: ");
		String roman= sc.nextLine();
		
		for(int i=0;i<roman.length();i++) {
			String[] arr= {roman.charAt(i)} ;
	...
	public static void m(String roman,HashMap<Integer, Integer> map) {
